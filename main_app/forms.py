...
class FeeCategoryForm(FormSettings):
    def __init__(self, *args, **kwargs):
        super(FeeCategoryForm, self).__init__(*args, **kwargs)
...
class FeePaymentForm(FormSettings):
    ...
    class Meta:
        model = FeePayment
        fields = ['student', 'fee', 'amount_paid', 'payment_date', 'payment_method', 'status', 'transaction_id', 'notes']
        widgets = {
